...
char *jumblr_importaddress(char *address)
{
    ...
    return(jumblr_issuemethod(KMDUSERPASS,(char *)"importaddress",params,KOMODOD_PORT));
}
...
char *jumblr_validateaddress(char *addr)
{
    ...
    return(jumblr_issuemethod(KMDUSERPASS,(char *)"validateaddress",params,KOMODOD_PORT));
}
...
char *jumblr_zgetnewaddress()
{
    char params[1024];
    sprintf(params,"[]");
    return(jumblr_issuemethod(KMDUSERPASS,(char *)"z_getnewaddress",params,KOMODOD_PORT));
}
...
char *jumblr_zlistoperationids()
{
    char params[1024];
    sprintf(params,"[]");
    return(jumblr_issuemethod(KMDUSERPASS,(char *)"z_listoperationids",params,KOMODOD_PORT));
}
...
char *jumblr_zgetoperationresult(char *opid)
{
    ...
    return(jumblr_issuemethod(KMDUSERPASS,(char *)"z_getoperationresult",params,KOMODOD_PORT));
}
...
char *jumblr_zgetoperationstatus(char *opid)
{
    char params[1024];
    sprintf(params,"[[\"%s\"]]",opid);
    return(jumblr_issuemethod(KMDUSERPASS,(char *)"z_getoperationstatus",params,KOMODOD_PORT));
}
...
char *jumblr_sendt_to_z(char *taddr,char *zaddr,double amount)
{
    ...
    LogPrintf("t -> z: %s\n",params);
    return(jumblr_issuemethod(KMDUSERPASS,(char *)"z_sendmany",params,KOMODOD_PORT));
}
...
char *jumblr_zlistaddresses()
{
    char params[1024];
    sprintf(params,"[]");
    return(jumblr_issuemethod(KMDUSERPASS,(char *)"z_listaddresses",params,KOMODOD_PORT));
}
...
char *jumblr_zlistreceivedbyaddress(char *addr)
{
    ...
    return(jumblr_issuemethod(KMDUSERPASS,(char *)"z_listreceivedbyaddress",params,KOMODOD_PORT));
}
...
char *jumblr_getreceivedbyaddress(char *addr)
{
    char params[1024];
    sprintf(params,"[\"%s\", 1]",addr);
    return(jumblr_issuemethod(KMDUSERPASS,(char *)"getreceivedbyaddress",params,KOMODOD_PORT));
}
...
char *jumblr_importprivkey(char *wifstr)
{
    ...
    return(jumblr_issuemethod(KMDUSERPASS,(char *)"importprivkey",params,KOMODOD_PORT));
}
...
char *jumblr_zgetbalance(char *addr)
{
    char params[1024];
    sprintf(params,"[\"%s\", 1]",addr);
    return(jumblr_issuemethod(KMDUSERPASS,(char *)"z_getbalance",params,KOMODOD_PORT));
}
...
char *jumblr_listunspent(char *coinaddr)
{
    ...
    return(jumblr_issuemethod(KMDUSERPASS,(char *)"listunspent",params,KOMODOD_PORT));
}
...
char *jumblr_gettransaction(char *txidstr)
{
    ...
    return(jumblr_issuemethod(KMDUSERPASS,(char *)"getrawtransaction",params,KOMODOD_PORT));
}
