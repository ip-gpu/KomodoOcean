...
#ifndef KOMODO_STREAMS_H
#define KOMODO_STREAMS_H
...
public:
    ...
    CBaseDataStream& read(char* pch, size_t nSize)
    {
        ...
        unsigned int nReadPosNext = nReadPos + (unsigned int)nSize;
...
public:
    ...
    /** Return true if the wrapped FILE* is NULL, false otherwise.
     */
    bool IsNull() const         { return (src == NULL); }
