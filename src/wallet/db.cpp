...
// A singleton for all wallets in this process
// Making this a static variable causes problems with testing, so
// switching to a shared_ptr
std::shared_ptr<CDBEnv> bitdb(new CDBEnv());
