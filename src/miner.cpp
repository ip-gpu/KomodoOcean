...
extern uint32_t ASSETCHAIN_INIT,KOMODO_INITDONE, ASSETCHAINS_ALGO, ASSETCHAINS_EQUIHASH, ASSETCHAINS_LASTERA, ASSETCHAINS_NONCESHIFT[], ASSETCHAINS_HASHESPERROUND[];
extern uint64_t ASSETCHAINS_COMMISSION, ASSETCHAINS_STAKED;
extern bool VERUS_MINTBLOCKS;
extern uint64_t ASSETCHAINS_REWARD[ASSETCHAINS_MAX_ERAS], ASSETCHAINS_TIMELOCKGTE, ASSETCHAINS_NONCEMASK[];
extern const char *ASSETCHAINS_ALGORITHMS[];
extern int32_t VERUS_MIN_STAKEAGE, ASSETCHAINS_VERUSHASH, ASSETCHAINS_LWMAPOS;
    ...
    try {
        ...
        while (true)
        {
            ...
            if ( ASSETCHAINS_STAKED != 0 )
            {
                ...
                LogPrintf(" PoW for staked coin PoS %d%% vs target %d%%\n",percPoS,(int32_t)ASSETCHAINS_STAKED);
            }
        ...
        while (true)
        {
            ...
            while (true)
            {
                /*if ( KOMODO_INSYNC == 0 )
                {
                    ...
                    LogPrintf("Mining when blockchain might not be in sync longest.%d vs %d\n",KOMODO_LONGESTCHAIN,Mining_height);
