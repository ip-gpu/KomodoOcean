...
#ifndef KOMODO_SERIALIZE_H
#define KOMODO_SERIALIZE_H
...
{
    return (unsigned int)(a.GetSerializeSize((int)nType, nVersion));
}
...
{
    (void)nVersion; (void)nType; return (unsigned int)(GetSizeOfCompactSize(v.size()) + v.size() * sizeof(T));
}
