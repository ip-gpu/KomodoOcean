...
#ifndef KOMODO_KEYSTORE_H
#define KOMODO_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/komodo/bips/blob/master/bip-0013.mediawiki
