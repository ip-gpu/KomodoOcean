...
void KomodoOceanGUI::createActions()
{
    ...
    zsendCoinsAction = new QAction(platformStyle->SingleColorIcon(":/icons/" + theme + "/z-send"), tr("&Z-Send"), this);
    ...
    zsendCoinsMenuAction = new QAction(platformStyle->TextColorIcon(":/icons/" + theme + "/z-send"), zsendCoinsAction->text(), this);
    ...
    usedReceivingZAddressesAction = new QAction(platformStyle->TextColorIcon(":/icons/" + theme + "/address-book"), tr("&Receiving z-addresses..."), this);
