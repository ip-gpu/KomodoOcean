 ...
 * Komodo system. There are three: the main network on which people trade goods
 ...
 */
std::unique_ptr<CChainParams> CreateChainParams(CBaseChainParams::Network chain);
